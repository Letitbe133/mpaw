<main>
    <section id="public">
        ...
        <div class="section-content">
            <h2><mark>
		Développez vos compétences <br/>en communication digitale</mark>
            </h2>
            <p>
...
C'est de là qu'est née Ma petite agence web. De l'envie de partager les galères et les bons plans, pour rendre le web plus beau et votre vie d'entrepreneur un chouilla plus facile ;)
    ...
    <section id="blog">
        ...
        <div class="section-content">
            <h2><mark>
		Devenez autonome dans votre communication digitale</mark>
            </h2>
            <p>
                Des astuces, des tutos, du vécu pour vous aider dans votre communication web. Découvrez par exemple les outils de communication libres et/ou gratuits disponibles
            </p>
            <a href="http://blog.mpaw.xyz"target="_blank">Le blog</a>
            <p>

                Suivez-nous sur Facebook. Nous y mettons régulièrement les ressources que nous trouvons pertinentes pour vous
            </p>
            <a href="https://www.facebook.com/MaPetiteAgenceWeb/" target="_blank"><img src="public/images/logoFB.svg" width="40rem" alt="Suivez-nous sur facebook" /></a>
        </div>
    </section>
    <section id="ateliers">
        <div class="section-header">
		...
		Accompagnement et conseils en communication web</mark>
            ...
            <a href="#" target="_blank"><img src="public/images/meetup-logo1200x630-transparent.png" width="300px" alt="Suivez-nous sur Meetup" /></a>
        </div>
    </section>
    <section id="pro">
      <div class="section-header">
